...
<div id="Tin_Trong_DM">
	<div class="DanhMuc">
		<strong><a href="/home">${COMMONINFO.homePage}</a> > ${newsCatalog.name}</strong>
	</div>
	<c:forEach items="${newses}" var="news">
		<div class="TinCT">
			<a href="${news_ct}/${url}/${news.id}"><img class="list_thumb" src="${news.image}" border="0"></a>
			<p class="title">
				<a href="${news_ct}/${url}/${news.id}">${news.title}</a>
